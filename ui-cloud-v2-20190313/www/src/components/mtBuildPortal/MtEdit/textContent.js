...
export default class TextContent extends Component {
    ...
    render() {
        ...
        const {point, showContent, count, tooBig} = this.state
        ...
        return (
            <div className='mt-activeContent'>
                ...
                <div style={isError ?
                    ...
                    {}}>
                    <pre contentEditable={true} placeholder="在这里输入你要发送的微信信息吧" id='activeContent'
                         className={!showContent ? 'noWords' : ''}
                    >
                    </pre>
                    <div className="qqfaceBox" style={{
                        ...
                        <div style={{width: '50px',color: tooBig?'red':'#B5BDC6'}}>{count}</div>
