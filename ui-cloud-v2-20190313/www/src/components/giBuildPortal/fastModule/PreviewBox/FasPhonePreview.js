...
export default class FastPhonePreview extends Component {
    constructor(props){
        super(props)
        this.state = {
            page: '1'
    ...
    render(){
        ...
        const templateItems = pageData.template.templateItems
        ...
        return (
            <div className="previewBox fastPhonePreview">
                    ...
                    <div className="phone">
                        <div className="innerPhone">
                            <div className="innerBox" style={{left:page=='1'?'0':'-100%'}}>
                                <div className="page" style={{background: `url(${pageData.backgroundPicUrl}) no-repeat center/cover`}}>
                                    ...
                                    <div className="codeBox">
                                        <div className="name">
                                            <img src={process.env.PUBLIC_URL+"/images/icon/logo1.png"} alt=""/>{pageData.groupName?pageData.groupName:'群名称'}
                                        </div>
