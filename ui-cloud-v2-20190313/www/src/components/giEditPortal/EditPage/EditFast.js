...
import '../../giBuildPortal/fastModule/Step2/index.css'
import PrevieBox from '../../giBuildPortal/fastModule/PreviewBox'
...
export default class Step2 extends Component {
    ...
    render(){
        ...
        const {setTemplateId,isEdit,showHandle,nextStep,actions,selectType,templateData,changeWhen} = this.props
        // console.log(params)
        return (
