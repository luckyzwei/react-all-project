...
import MmEmptyList from '../MmEmptyList'
import MmUnEmptyList from '../MmUnEmptyList'

import {getMomentList} from '../../../funStore/MomentApi'
    ...
    handleSearchParams(parname, parvalue) {
        ...
        switch (parname) {
            ...
            case "tmTime":
                ...
                break;
            case "itemGroup":
                searchParams.itemGroup = parvalue
                break;
        ...
        getMomentList(params).then(res => {
            ...
            if (res.resultCode == "100") {
                this.setState({
                    ...
                    spaceListData: !(res.resultContent.length === 0 && !params.title && !params.status && !params.itemGroup && !params.userId)
                })
            } else {
