...
export default class MtGroup extends Component {
    ...
    componentDidMount() {
        ...
        getSearchGroup(params).then(res => {
            ...
            if (res.resultCode == "100") {
                ...
                // console.log(this.props.groupIdArray,'groupIdArray====');
    ...
    render() {
        ...
        let {saveGroupStatus, changeStep, repeatGroupId,handleVerify} = this.props;
        return (
            <div className='MtGroup'>
                ...
                <div className="MtGroup-footer">
                    ...
                    />
                    <div className={`${handleVerify?'saveBtn':'saveBtn notSavebtn'}`}
                         onClick={()=>{handleVerify?this.props.saveGroupId(searchChooseArr):null}}>
                        保存
                    </div>
                </div>
                {
