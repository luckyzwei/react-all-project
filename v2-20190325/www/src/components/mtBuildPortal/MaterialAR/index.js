    ...
    return (
        ...
        data.map(v => (
            <div className="item public-box" onClick={() => {
                params[1]==v?setParams('','',''):setParams('public',v,4)
            }}>
                <div className="item-content-box">
        ...
        return (
            <div className="Material-boxAR">
                ...
                <div className="btm-box">
                    <p className="howImport">如何导入素材？<p>1. 将素材（图片、链接、小程序、公众号名片及语音）发送给小助手；<br/>2. 点击页面上刷新按钮，可查看收录的素材并进行管理</p></p>
                    <ButtonBox 
                        btnTxt={'确定'}
                    ...
                    <ButtonBox 
                        btnTxt={'返回'}
                        btnStyle={{width: '80px',float: 'right',marginRight: '48px'}}
                        btnFunc={() => {this.props.showModal()}}
                    />
                    {
                        caveat?
