...
import {EditText, EditImg, EditLink, EditSLink, EditWexx, EditSpace, EditPublic, EditVoice} from '../MatterEdit/editText';
    ...
    render() {
        ...
        return (
            <div className='MtEdit'>
                ...
                {
                    showMaterial?
                    <Material paramsValue={paramsValue} addNav={this.addNav} showModal={this.showModal}/>
                    :''
                }
