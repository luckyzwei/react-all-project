...
export default class TypeSelect extends Component {
    ...
    async componentDidMount(){
        await this.props.customize&&this.selectBuildType('ADD')
        if (this.state.buildFlag=='INIT') {
            ...
            :<div className="typeSelect">
                <div className="inner" style={{display: buildFlag=='ADD'?'block':'none'}}>
                    <div className="step2">
                        ...
                        {/* <div className="gb-preinstall">
                            <p className="preinstall-title">入群页面推荐</p>
                            <div className="preinstall-box">
                                <div className="preinstall-item">
                                    <p>我有许多门店需要建群<em></em></p>
                                </div>
                                <div className="preinstall-item">
                                    <p>我需要快速汇拢品牌粉丝<em></em></p>
                                </div>
                                <div className="preinstall-item">
                                    <p>我有一套线上的课程需要兜售<em></em></p>
                                </div>
                                <div className="preinstall-item">
                                    <p>我有线上的课程需要兜售<em></em></p>
                                </div>
                            </div>
                        </div> */}
