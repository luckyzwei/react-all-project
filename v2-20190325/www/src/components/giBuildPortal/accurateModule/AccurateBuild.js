...
export default class AccurateBuild extends Component {
    ...
    render(){
        ...
        const {selectType,cancelBuild,actions,modalType} = this.props
        let view
        switch (step) {
            case 1:
                view = <Step1Accurate modalType={modalType} setparamsHandle={this.setData} viewType={'ADD'} nextStep={this.nextStep} templateData={templateData} selectType={selectType} />
                break;
            case 2: 
