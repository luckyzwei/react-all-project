...
export default class SearchInput extends Component {
    ...
    render(){
        ...
        const {dataList,label,inputStyle,deleteFlag,placeholder,allFlag} = this.props
        return (
            <div className="SearchInput">
                ...
                <div className="SearchInput-input" onClick={this.focusHandle} style={inputStyle}>
                    ...
                    >
                        {
                            allFlag
                            ?<div key={allFlag.value} className={allFlag.value==paramValue?"SearchInput-option SearchInput-option-select":"SearchInput-option"}
                                onMouseDown={()=>{this.selectHandle(allFlag)}}
                            >
                                {allFlag.key}
                            </div>
                            :''
